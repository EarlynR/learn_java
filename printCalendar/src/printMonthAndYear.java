/**
 ...
 @Objective:
 Print a calendar month per the user's instructions. The program
 will ask the user to display the month of a specific year.
...
public class printMonthAndYear {
    ...
    public static void main ( String [] args ) {
        ...
        System.out.println("\n\n");
        System.out.println("Please tell me the month and year you want to " +
                "print. Please use integers instead of strings.");

        System.out.print("Give me a month (in digits): ");
        monthToDisplay = input.nextInt();

        System.out.print("Give me the year: ");
        yearToDisplay = input.nextInt();

        printMonthCalendar(monthToDisplay, yearToDisplay);
